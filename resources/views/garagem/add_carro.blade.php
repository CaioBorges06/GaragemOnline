        ...
        <div class="container" style="margin-bottom: 80px;">
                    <div class="contact__form" >
                        <form method="POST" action="#" >
                            ...
                            <div>
                                <label for="foto1">Link da Foto 1:</label>
                                <input type="text" name="foto1" id="foto1" placeholder="Cole o link da imagem 1">
                            </div>

                            <div>
                                <label for="foto2">Link da Foto 2:</label>
                                <input type="text" name="foto2" id="foto2" placeholder="Cole o link da imagem 2">
                            </div>

                            <div>
                                <label for="foto3">Link da Foto 3:</label>
                                <input type="text" name="foto3" id="foto3" placeholder="Cole o link da imagem 3">
                            </div>
